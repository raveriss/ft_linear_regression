...
def _line_points(
    ...
    prix_extremes = [
        estimate_price(km, coefficient_intercept, coefficient_pente)
...
def plot_residuals(
    ...
    for kilometre, prix_reel in donnees_reelles:
        ...
        prix_prevu = estimate_price(kilometre, coefficient_intercept, coefficient_pente)
...
def _ecart_type_residus(
    ...
    residus = [
        valeur_observee - estimate_price(valeur_entree, intercept, pente)
...
def plot_confidence_band(
    ...
    liste_prix_predits = [
        estimate_price(km, coefficient_intercept, coefficient_pente) for km in grille_km
    ]
...
def split_outliers(
    ...
    liste_residus = [
        prix_reel - estimate_price(km, coefficient_intercept, coefficient_pente)
...
def plot_points(
    ...
    if inliers_km_prix:
        ...
        module_matplotlib.scatter(
            ...
            # étiquette légende pour interprétation claire
            label="donnees",
        )
    ...
    if outliers_km_prix:
        ...
        module_matplotlib.scatter(
            ...
            # couleur vive pour signaler qu’ils s’écartent de la norme
            color="orange",
            # légende claire pour interprétation par l’utilisateur
            label="outliers",
        )
